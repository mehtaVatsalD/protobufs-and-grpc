...
@javax.annotation.Generated(
    ...
    comments = "Source: services/UserService.proto")
public final class UserServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<UserRegistrationRequest,
          UserResponse> getRegisterUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RegisterUser",
      requestType = UserRegistrationRequest.class,
      responseType = UserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<UserRegistrationRequest,
          UserResponse> getRegisterUserMethod() {
    io.grpc.MethodDescriptor<UserRegistrationRequest, UserResponse> getRegisterUserMethod;
      ...
      synchronized (UserServiceGrpc.class) {
        if ((getRegisterUserMethod = UserServiceGrpc.getRegisterUserMethod) == null) {
          UserServiceGrpc.getRegisterUserMethod = getRegisterUserMethod = 
              io.grpc.MethodDescriptor.<UserRegistrationRequest, UserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "services.UserService", "RegisterUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  UserRegistrationRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<UserQueryByIdRequest,
          UserResponse> getGetUserByIdMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetUserById",
      requestType = UserQueryByIdRequest.class,
      responseType = UserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<UserQueryByIdRequest,
          UserResponse> getGetUserByIdMethod() {
    io.grpc.MethodDescriptor<UserQueryByIdRequest, UserResponse> getGetUserByIdMethod;
      ...
      synchronized (UserServiceGrpc.class) {
        if ((getGetUserByIdMethod = UserServiceGrpc.getGetUserByIdMethod) == null) {
          UserServiceGrpc.getGetUserByIdMethod = getGetUserByIdMethod = 
              io.grpc.MethodDescriptor.<UserQueryByIdRequest, UserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "services.UserService", "GetUserById"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  UserQueryByIdRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  UserResponse.getDefaultInstance()))
  ...
  public static abstract class UserServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getUserById(UserQueryByIdRequest request,
                            io.grpc.stub.StreamObserver<UserResponse> responseObserver) {
  ...
  public static final class UserServiceBlockingStub extends io.grpc.stub.AbstractStub<UserServiceBlockingStub> {
    ...
    /**
     */
    public UserResponse getUserById(UserQueryByIdRequest request) {
      return blockingUnaryCall(
  ...
  public static final class UserServiceFutureStub extends io.grpc.stub.AbstractStub<UserServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<UserResponse> registerUser(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<UserResponse> getUserById(
        UserQueryByIdRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER_USER:
          serviceImpl.registerUser((UserRegistrationRequest) request,
              (io.grpc.stub.StreamObserver<UserResponse>) responseObserver);
          break;
        case METHODID_GET_USER_BY_ID:
          serviceImpl.getUserById((UserQueryByIdRequest) request,
              (io.grpc.stub.StreamObserver<UserResponse>) responseObserver);
          break;
        default:
